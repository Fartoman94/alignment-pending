...
signal rival_launched(rival_id: String, generation: int)
signal audit_triggered()
signal ending_triggered(ending_id: String)
signal funding_round_accepted(round_id: String)
signal board_demand_triggered()
signal legal_case_filed(case_type_id: String)
signal legal_case_resolved(case_type_id: String, outcome: String)
signal agent_permission_changed(deployment_id: String, permission_id: String, granted: bool)
