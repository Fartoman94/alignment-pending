# P17 — Users, pricing and revenue

## Context
Read `CLAUDE.md`, the relevant GDD/architecture documents, and current implementation status before editing.

## Task
Implement cohort-based demand for hobbyist/developer/business segments, price elasticity and inference costs.
...
## Acceptance criteria
Revenue/cost traceable; no per-user Node simulation.
