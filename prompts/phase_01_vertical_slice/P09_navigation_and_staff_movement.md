# P09 — Navigation and staff movement

## Context
Read `CLAUDE.md`, the relevant GDD/architecture documents, and current implementation status before editing.

## Task
Implement NavigationRegion3D office movement, simple staff state machine and destination reservation.
...
## Acceptance criteria
20 staff move without obvious deadlocks; paused game stops simulation tasks.
