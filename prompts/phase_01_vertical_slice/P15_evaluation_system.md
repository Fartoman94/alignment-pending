# P15 — Evaluation system

## Context
Read `CLAUDE.md`, the relevant GDD/architecture documents, and current implementation status before editing.

## Task
Implement capability/reliability/safety/cost evaluations with uncertainty ranges and hidden latent risk partially revealed by depth.
...
## Acceptance criteria
Player sees what is known/unknown; repeated evals cost resources and reduce uncertainty.
