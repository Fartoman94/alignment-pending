# P10 — Staff model and hiring

## Context
Read `CLAUDE.md`, the relevant GDD/architecture documents, and current implementation status before editing.

## Task
Implement staff data, generated fictional names, roles, skills, salary, morale, fatigue, values; hiring panel.
...
## Acceptance criteria
Hire/fire/inspect staff; payroll deducted; save/load stable IDs.
