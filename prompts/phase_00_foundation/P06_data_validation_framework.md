# P06 — Data validation framework

## Context
Read `CLAUDE.md`, the relevant GDD/architecture documents, and current implementation status before editing.

## Task
Create startup validator for JSON/Resource IDs, duplicate IDs, required fields and invalid numeric ranges.
...
## Acceptance criteria
Debug build reports actionable errors; seed event data validates.
