# P42 — Accessibility completion

## Context
Read `CLAUDE.md`, the relevant GDD/architecture documents, and current implementation status before editing.

## Task
Implement remapping, UI scale, reduced motion, high contrast, colorblind redundancy, pause-on-event and readable tooltip timing.
...
## Acceptance criteria
Accessibility regression checklist passes.
