# P43 — Controller support

## Context
Read `CLAUDE.md`, the relevant GDD/architecture documents, and current implementation status before editing.

## Task
Add controller navigation, camera, selection and build radial/toolbar navigation with keyboard parity.
...
## Acceptance criteria
Complete vertical slice without mouse.
