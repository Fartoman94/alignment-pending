# P37 — Endings and epilogues

## Context
Read `CLAUDE.md`, the relevant GDD/architecture documents, and current implementation status before editing.

## Task
Implement ending evaluator with at least 6 ending families plus secret simulation ending.
...
## Acceptance criteria
Ending summarizes tracked consequences, not moral score.
