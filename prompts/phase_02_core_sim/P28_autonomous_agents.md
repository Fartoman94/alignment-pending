# P28 — Autonomous agents

## Context
Read `CLAUDE.md`, the relevant GDD/architecture documents, and current implementation status before editing.

## Task
Add agent capabilities: coding, support, research assistance, tool access and spending permissions.
...
## Acceptance criteria
Each autonomy permission has productivity gain + explicit risk surface.
