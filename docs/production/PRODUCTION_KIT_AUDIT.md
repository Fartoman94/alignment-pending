...
| `architecture/office/*` (column, glass door/wall, carpet/wood floor, reception wall) | 7 | Not started — no office-tier art pass exists yet beyond the garage's |
...
| `research/*` (lab bench, oscilloscope, research terminal, GPU test rig, whiteboard, tablet) | 5 (1 name-dupe) | Not started — `safety_lab`/research buildables are still on procedural-box fallback (documented gap, `ASSET_PROVENANCE.md` line 26) |
